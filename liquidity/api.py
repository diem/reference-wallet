...
from libra_utils.types.liquidity.errors import AlreadySettled
from libra_utils.types.liquidity.quote import QuoteId
from libra_utils.types.liquidity.trade import Direction, TradeId
from libra_utils.types.liquidity.settlement import DebtId
...
def trade_and_execute() -> Union[str, Response]:
    ...
    libra_deposit_address = (
        data["libra_deposit_address"] if "libra_deposit_address" in data else None
    )
    ...
    trade_id = lp.trade_and_execute(
        quote_id=quote_id,
        direction=direction,
        libra_bech32_deposit_address=libra_deposit_address,
