...
#         trade = make_trade(CurrencyPairs.XUS_USD, Direction.Buy)
...
#     trades = [
#         make_trade(CurrencyPairs.XUS_USD, Direction.Buy, 1),
#         make_trade(CurrencyPairs.XUS_USD, Direction.Buy, 2),
#         make_trade(CurrencyPairs.XUS_EUR, Direction.Buy, 3),
#         make_trade(CurrencyPairs.XUS_USD, Direction.Buy, 4),
#     ]
#     consolidated = sorted(
...
#     trade1 = make_trade(CurrencyPairs.XUS_USD, Direction.Buy)
#     trade2 = make_trade(CurrencyPairs.XUS_EUR, Direction.Buy)
#     Session.add(trade1)
#     Session.add(trade2)
#     Session.commit()
#
