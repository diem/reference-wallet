...
from libra_utils.types.liquidity.quote import QuoteData, QuoteId
from libra_utils.types.liquidity.settlement import DebtData
from libra_utils.types.liquidity.trade import TradeId, Direction, TradeData
...
class LpClient:
    ...
    def trade_and_execute(
        ...
        if libra_deposit_address:
            request_body["libra_deposit_address"] = libra_deposit_address
