...
def test_get_info_charge(validator, vasp_proxy: VaspProxy):
    ...
    vasp_proxy_payment_info = vasp_proxy.get_payment_info(reference_id, validator_address)

    assert vasp_proxy_payment_info is not None
    assert vasp_proxy_payment_info.vasp_address == validator_payment_info.vasp_address == validator_address
    assert vasp_proxy_payment_info.reference_id == validator_payment_info.reference_id == reference_id
    ...
    assert vasp_proxy_payment_info.expiration is None
